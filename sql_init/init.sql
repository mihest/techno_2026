-- Cleaned SQL dump for pgAdmin Query Tool / psql
-- Run this in a NEW/EMPTY database.
-- Required extension for geography(Point,4326): PostGIS
...
DO $$ BEGIN
    CREATE TYPE public.userroleenum AS ENUM ('USER', 'MODERATOR', 'ADMIN');
EXCEPTION WHEN duplicate_object THEN NULL;
END $$;
ALTER TYPE public.userroleenum ADD VALUE IF NOT EXISTS 'USER';
ALTER TYPE public.userroleenum ADD VALUE IF NOT EXISTS 'MODERATOR';
ALTER TYPE public.userroleenum ADD VALUE IF NOT EXISTS 'ADMIN';

DO $$ BEGIN
    CREATE TYPE public.queststatusenum AS ENUM ('DRAFT', 'MODERATION', 'PUBLISHED', 'REJECTED', 'ARCHIVED');
EXCEPTION WHEN duplicate_object THEN NULL;
END $$;
ALTER TYPE public.queststatusenum ADD VALUE IF NOT EXISTS 'DRAFT';
ALTER TYPE public.queststatusenum ADD VALUE IF NOT EXISTS 'MODERATION';
ALTER TYPE public.queststatusenum ADD VALUE IF NOT EXISTS 'PUBLISHED';
ALTER TYPE public.queststatusenum ADD VALUE IF NOT EXISTS 'REJECTED';
ALTER TYPE public.queststatusenum ADD VALUE IF NOT EXISTS 'ARCHIVED';

DO $$ BEGIN
    CREATE TYPE public.checkpointquestiontypeenum AS ENUM ('CHOICE', 'CODE', 'TEXT', 'PHOTO');
EXCEPTION WHEN duplicate_object THEN NULL;
END $$;
ALTER TYPE public.checkpointquestiontypeenum ADD VALUE IF NOT EXISTS 'CHOICE';
ALTER TYPE public.checkpointquestiontypeenum ADD VALUE IF NOT EXISTS 'CODE';
ALTER TYPE public.checkpointquestiontypeenum ADD VALUE IF NOT EXISTS 'TEXT';
ALTER TYPE public.checkpointquestiontypeenum ADD VALUE IF NOT EXISTS 'PHOTO';

DO $$ BEGIN
    CREATE TYPE public.questsessionmodeenum AS ENUM ('SOLO', 'TEAM');
EXCEPTION WHEN duplicate_object THEN NULL;
END $$;
ALTER TYPE public.questsessionmodeenum ADD VALUE IF NOT EXISTS 'SOLO';
ALTER TYPE public.questsessionmodeenum ADD VALUE IF NOT EXISTS 'TEAM';

DO $$ BEGIN
    CREATE TYPE public.questsessionstatusenum AS ENUM ('ACTIVE', 'COMPLETED', 'ABANDONED');
EXCEPTION WHEN duplicate_object THEN NULL;
END $$;
ALTER TYPE public.questsessionstatusenum ADD VALUE IF NOT EXISTS 'ACTIVE';
ALTER TYPE public.questsessionstatusenum ADD VALUE IF NOT EXISTS 'COMPLETED';
ALTER TYPE public.questsessionstatusenum ADD VALUE IF NOT EXISTS 'ABANDONED';
